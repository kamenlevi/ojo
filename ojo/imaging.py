...
def auto_rotate_pil(orientation, im):
    ...
    if orientation is None:
        ...
        result = im.transpose(Image.Transpose.FLIP_LEFT_RIGHT)
    elif orientation in (3, "Rotate 180"):
        result = im.transpose(Image.Transpose.ROTATE_180)
    elif orientation in (4, "Mirror vertical"):
        result = im.transpose(Image.Transpose.FLIP_TOP_BOTTOM)
    elif orientation in (5, "Mirror horizontal and rotate 270 CW"):
        result = im.transpose(Image.Transpose.FLIP_LEFT_RIGHT).transpose(Image.Transpose.ROTATE_90)
    elif orientation in (6, "Rotate 90 CW"):
        result = im.transpose(Image.Transpose.ROTATE_270)
    elif orientation in (7, "Mirror horizontal and rotate 90 CW"):
        result = im.transpose(Image.Transpose.FLIP_LEFT_RIGHT).transpose(Image.Transpose.ROTATE_270)
    elif orientation in (8, "Rotate 270 CW"):
        result = im.transpose(Image.Transpose.ROTATE_90)
    else:
        result = im
